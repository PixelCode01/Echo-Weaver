...
const SETTINGS = {
    ...
    ENEMY_SPAWN_RATE_HARD: 30,
    ENEMIES_PER_WAVE_INCREMENT_HARD: 4,
    SPEED_LIMIT_100: 1.5,
    SPEED_LIMIT_200: 2.0,
    SPEED_LIMIT_AFTER_200: 3.5,

    MOBILE_TOUCH_COOLDOWN_BASE: 50,
    MOBILE_TOUCH_COOLDOWN_MAX: 200,
    MOBILE_TOUCH_COOLDOWN_SCORE_FACTOR: 0.1,
    ...
    WAVE_COLOR: '#00ffff',
    WAVE_WIDTH: 3,
    WAVE_WIDTH_BOOST_MULTIPLIER: 1.5,
    ...
    PARTICLE_VELOCITY_VARIANCE: 3.5,
    PARTICLE_LIFETIME: 45,

    CHAIN_REACTION_ENABLED: true,
    CHAIN_REACTION_RADIUS: 120,

    BOSS_ENEMY_SPEED_MULTIPLIER: 0.6,
    BOSS_ENEMY_SCORE_MULTIPLIER: 15,
};
...
function adjustSettingsForDevice() {
    ...
    if (isMobile) {
        ...
        SETTINGS.ECHO_BURST_COOLDOWN = 240;
    }
}
